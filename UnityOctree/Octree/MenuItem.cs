...
namespace Hsys
{
    ...
    public class MenuItem : EditorWindow
    {
        ...
        [UnityEditor.MenuItem("Tools/Hsys/Octree/CreateTree"), Tooltip("Octree 创建树")]
...
/*            _myoctree = new GameObject("MyTree");
            ...
            CreateOctreeObj();
            SetOctreeObjPosition(ihe);
        }
        [UnityEditor.MenuItem("Tools/Hsys/Octree/SetRange"), Tooltip("设置范围")]
        ...
        [SerializeField] private static isHalfEnum ihe = new isHalfEnum();
        ...
        private void SetOctreeObjName(isHalfEnum _ishalf)
        {
            if (_octnode == null) { return; }
            string setRangestring = _setRange.ToString();
            switch (_ishalf)
            { 
                case isHalfEnum.HALF:
                    _octnode.obj[0].name = "0_0_" + setRangestring;
                    _octnode.obj[1].name = "0_" + setRangestring + "_0";
                    _octnode.obj[2].name = setRangestring + "_0_0";
                    _octnode.obj[3].name = setRangestring + "_" + setRangestring + "_" + setRangestring;
                    break;
                case isHalfEnum.NORMAL:
        ...
        private static void SetOctreeObjPosition(isHalfEnum _ishalf)
        {
            if(_octnode == null) { return; }
            switch (_ishalf)
            {
        ...
        private void DestroyOctreeObj()
        {
            ...
            for(int index = 0; index < _octnode.obj.Length; index+=1)
            {
                if (_octnode.obj[index] == null) { continue; }
